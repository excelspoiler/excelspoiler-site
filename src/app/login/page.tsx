        ...
        <div className="mx-auto w-full max-w-sm lg:w-96">
          <div>
            ...
            <p className="mt-2 text-sm text-gray-600">
              Non hai un account?{' '}
              <Link href="/register" className="font-medium text-excel-green hover:text-excel-green-light">
                Registrati qui
              </Link>
            </p>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <div className="mt-1">
                  <input
                    ...
                    className="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md placeholder-gray-400 focus:outline-none focus:ring-excel-green focus:border-excel-green"
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="text-sm">
                  <Link href="/forgot-password" className="font-medium text-excel-green hover:text-excel-green-light">
            ...
            <div className="mt-6">
              ...
              <div className="mt-6 grid grid-cols-2 gap-3">
                <button 
                  ...
                  className="w-full inline-flex justify-center py-2 px-4 border-2 border-gray-300 rounded-md bg-white text-sm font-medium text-gray-500 hover:bg-gray-50 hover:border-excel-green"
                >
        ...
        <div className="absolute inset-0 gradient-bg-1 flex items-center justify-center">
          <div className="text-center px-8">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-md">
              Accedi per continuare il tuo percorso di apprendimento Excel e 
              sbloccare tutto il potenziale dei tuoi dati.
            </p>
            ...
            <div className="grid grid-cols-1 gap-6 max-w-sm mx-auto">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-700">Accesso ai tuoi corsi</span>
              </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-700">Tracciamento progressi</span>
              </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-700">Community e supporto</span>
              </div>
            </div>
          </div>
        </div>
